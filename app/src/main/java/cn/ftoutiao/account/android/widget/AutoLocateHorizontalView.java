...
public class AutoLocateHorizontalView extends RecyclerView {
    ...
    private void init() {
        ...
        mBackgroudPaint.setColor(Color.parseColor("#ffffff"));
...
//        calculateSelectedPos();
     ...
     * @return
     */
    public int getHeaderFooterOffsetWidth(ViewGroup parent) {
        return 0;
        //dp2px(getContext(), 0)
//        return parent.getMeasuredWidth() / 2 - (parent.getMeasuredWidth() / itemCount) / 2;
    }
    ...
    class WrapperAdapter extends RecyclerView.Adapter {
        ...
        public WrapperAdapter(Adapter adapter, Context context, int itemCount) {
            ...
            if (adapter instanceof IAutoLocateHorizontalView) {
                itemRootView = ((IAutoLocateHorizontalView) adapter).getItemView();
            } else {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == HEADER_FOOTER_TYPE) {
                ...
                //item width 居中
                headerFooterWidth = getHeaderFooterOffsetWidth(parent);
            ...
            ViewGroup.LayoutParams params = itemRootView.getLayoutParams();
            if (params != null) {
                params.width = width;
                itemWidth = width;
                itemRootView.setLayoutParams(params);
            }
...
//                }
        ...
        public int getItemCount() {
            return adapter.getItemCount() + 2; //header & footer
        }
...
//                listener.selectedPositionChanged(position);
//                if (!isHeaderOrFooter(position)) {
//                    adapter.onBindViewHolder(holder, position - 1);
//                    if (selectPos == position - 1) {
//                        ((IAutoLocateHorizontalView) adapter).onViewSelected(true, position - 1, holder, itemWidth);
