package cn.ftoutiao.account.android.widget.webview.parser;/**
...
import cn.ftoutiao.account.android.widget.webview.JsBridgeResponse;
        ...
        try {
            ...
            JsBridgeResponse response = new JsBridgeResponse(object) {
                ...
                public void dealJsBridge(String messageId, String version, String uniqueId, JsonObject param) {
                    Logger.e("js调用Android", "messageId===" + messageId + "---version===" + version +
