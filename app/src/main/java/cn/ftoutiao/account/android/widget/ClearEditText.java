...
public class ClearEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        switch (typedArray.getInteger(R.styleable.ClearEditText_clearButtonMode, 0)) {
            case 1:
        ...
        int clearButton = typedArray.getResourceId(R.styleable.ClearEditText_clearButtonDrawable, android.R.drawable.ic_delete);
        typedArray.recycle();
