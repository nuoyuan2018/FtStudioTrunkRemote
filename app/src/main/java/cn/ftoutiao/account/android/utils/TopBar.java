...
public class TopBar extends RelativeLayout {
    ...
    private void init() {
        ...
        topbarBg = (RelativeLayout) findViewById(R.id.topbar_layout);
        bottomLine = (View) findViewById(R.id.bottom_line);
        leftLayout = (LinearLayout) findViewById(R.id.topbarLeftLinearLayout);
        leftTextView = (TextView) findViewById(R.id.back_tv);
        topTitleTextView = (TextView) findViewById(R.id.text_title);
        rightContentLayout = (LinearLayout) findViewById(R.id.rightContentLayout);
        rightButton = (ImageButton) findViewById(R.id.ic_comright_iv);
        rightTextView = (TextView) findViewById(R.id.ic_comright_tv);
    ...
    public void setLeftIconResource(int backImageResId) {
        if (leftLayout != null) {
            if (backImageResId >= 0) {
                ImageView backImage = (ImageView) findViewById(R.id.ic_comleft_imgbg);
    ...
    public void setLeftTextColor(int color) {
        TextView backTitle = (TextView) findViewById(R.id.back_tv);
