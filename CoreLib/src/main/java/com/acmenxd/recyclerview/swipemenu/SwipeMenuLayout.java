...
public final class SwipeMenuLayout extends FrameLayout {
     ...
     *
     */
    private void setDefaultDelView() {
        rightMenuView.addView(LayoutInflater.from(getContext()).inflate(R.layout.activity_recycler_swipe_menu_right, null));
    ...
    public void smoothOpenMenu(@IntRange(from = 0) int duration) {
