...
//        getWindow().setBackgroundDrawableResource(android.R.color.transparent);
    ...
    public static class Builder {
        ...
        public Builder setCancelBackgroupResource(int resource) {
            mDialog.mView.setCancelBackgroupResource(resource);
            return this;
        }
        ...
        public Builder setCancelButtonListener(OnCancelListener l) {
        ...
        public Builder setBottomDivideColor(int color) {
            ...
            mDialog.mView.setmBottomDividerColor(color);
            return this;
        }
