...
public class NyDialogView extends RelativeLayout {
    ...
    public void setCancelBackgroupResource(int res) {
        mCancelBottomView.setBackgroundResource(res);
    }
    ...
    public void setContentView(final View v) {
        ...
        final LayoutParams rp = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        rp.addRule(RelativeLayout.CENTER_IN_PARENT);
    ...
    public void setmBottomDividerColor(int color) {
        mBottomDivider.setBackgroundColor(getResources().getColor(color));
    }
}
